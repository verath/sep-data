...
pub enum SEOutputData {
    ...
    SEHeadHeading(SETypeFloat),
    SEHeadPitch(SETypeFloat),
    SEHeadRoll(SETypeFloat),
    SEHeadRotationQ(SETypeFloat),
    ...
    SEGazeDirectionQ(SETypeFloat),
    SELeftEyePosition(SETypePoint3D),
    SELeftGazeDirection(SETypeVect3D),
    SELeftGazeDirectionQ(SETypeFloat),
    SERightEyePosition(SETypePoint3D),
    SERightGazeDirection(SETypeVect3D),
    SERightGazeDirectionQ(SETypeFloat),
    SEGazeHeading(SETypeFloat),
    SEGazePitch(SETypeFloat),
    SELeftGazeHeading(SETypeFloat),
    SELeftGazePitch(SETypeFloat),
    SERightGazeHeading(SETypeFloat),
    SERightGazePitch(SETypeFloat),
    SEFilteredGazeDirection(SETypeVect3D),
    SEFilteredGazeDirectionQ(SETypeFloat),
    SEFilteredLeftGazeDirection(SETypeVect3D),
    SEFilteredLeftGazeDirectionQ(SETypeFloat),
    SEFilteredRightGazeDirection(SETypeVect3D),
    SEFilteredRightGazeDirectionQ(SETypeFloat),
    SEFilteredGazeHeading(SETypeFloat),
    SEFilteredGazePitch(SETypeFloat),
    SEFilteredLeftGazeHeading(SETypeFloat),
    SEFilteredLeftGazePitch(SETypeFloat),
    SEFilteredRightGazeHeading(SETypeFloat),
    SEFilteredRightGazePitch(SETypeFloat),
    SESaccade(SETypeU32),
    ...
    SEEyelidOpening(SETypeFloat),
    SEEyelidOpeningQ(SETypeFloat),
    SELeftEyelidOpening(SETypeFloat),
    SELeftEyelidOpeningQ(SETypeFloat),
    SERightEyelidOpening(SETypeFloat),
    SERightEyelidOpeningQ(SETypeFloat),
    ...
    SEPupilDiameter(SETypeFloat),
    SEPupilDiameterQ(SETypeFloat),
    SELeftPupilDiameter(SETypeFloat),
    SELeftPupilDiameterQ(SETypeFloat),
    SERightPupilDiameter(SETypeFloat),
    SERightPupilDiameterQ(SETypeFloat),
    SEFilteredPupilDiameter(SETypeFloat),
    SEFilteredPupilDiameterQ(SETypeFloat),
    SEFilteredLeftPupilDiameter(SETypeFloat),
    SEFilteredLeftPupilDiameterQ(SETypeFloat),
    SEFilteredRightPupilDiameter(SETypeFloat),
    SEFilteredRightPupilDiameterQ(SETypeFloat),
    SEGPSPosition(SETypePoint2D),
    SEGPSGroundSpeed(SETypeFloat),
    SEGPSCourse(SETypeFloat),
    SEGPSTime(SETypeU64),
    ...
    SEEstimatedGazeDirectionQ(SETypeFloat),
    SEEstimatedGazeHeading(SETypeFloat),
    SEEstimatedGazePitch(SETypeFloat),
    SEEstimatedLeftEyePosition(SETypePoint3D),
    SEEstimatedLeftGazeDirection(SETypeVect3D),
    SEEstimatedLeftGazeDirectionQ(SETypeFloat),
    SEEstimatedLeftGazeHeading(SETypeFloat),
    SEEstimatedLeftGazePitch(SETypeFloat),
    SEEstimatedRightEyePosition(SETypePoint3D),
    SEEstimatedRightGazeDirection(SETypeVect3D),
    SEEstimatedRightGazeDirectionQ(SETypeFloat),
    SEEstimatedRightGazeHeading(SETypeFloat),
    SEEstimatedRightGazePitch(SETypeFloat),
    SEFilteredEstimatedGazeDirection(SETypeVect3D),
    SEFilteredEstimatedGazeDirectionQ(SETypeFloat),
    SEFilteredEstimatedGazeHeading(SETypeFloat),
    SEFilteredEstimatedGazePitch(SETypeFloat),
    SEFilteredEstimatedLeftGazeDirection(SETypeVect3D),
    SEFilteredEstimatedLeftGazeDirectionQ(SETypeFloat),
    SEFilteredEstimatedLeftGazeHeading(SETypeFloat),
    SEFilteredEstimatedLeftGazePitch(SETypeFloat),
    SEFilteredEstimatedRightGazeDirection(SETypeVect3D),
    SEFilteredEstimatedRightGazeDirectionQ(SETypeFloat),
    SEFilteredEstimatedRightGazeHeading(SETypeFloat),
    SEFilteredEstimatedRightGazePitch(SETypeFloat),
    ...
    SELeftBlinkClosingAmplitude(SETypeFloat),
    SELeftBlinkOpeningAmplitude(SETypeFloat),
    SELeftBlinkClosingSpeed(SETypeFloat),
    SELeftBlinkOpeningSpeed(SETypeFloat),
    SERightBlinkClosingMidTime(SETypeU64),
    SERightBlinkOpeningMidTime(SETypeU64),
    SERightBlinkClosingAmplitude(SETypeFloat),
    SERightBlinkOpeningAmplitude(SETypeFloat),
    SERightBlinkClosingSpeed(SETypeFloat),
    SERightBlinkOpeningSpeed(SETypeFloat),
